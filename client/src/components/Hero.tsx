  ...
  return (
    <section className="relative w-full bg-[#f8fafc] overflow-hidden pt-12 pb-20">
      ...
      <div className="max-w-[1280px] mx-auto px-4 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-8">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-500 max-w-md leading-relaxed">
              UniMarket — це зручна платформа, де студенти можуть купувати та продавати навчальні матеріали, гаджети, конспекти та послуги. Все для вашого університетського життя в одному місці.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6">
            <StatItem 
              icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>} 
              text="2 400+ товарів" 
            />
            <StatItem 
              icon={<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>} 
              text="850+ студентів" 
            />
            <StatItem 
        ...
        {/* ПРАВА ЧАСТИНА: Віджети (Картинки) */}
